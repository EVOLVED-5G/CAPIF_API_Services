...
def cert_validation():
    def _cert_validation(f):
        ...
        def __cert_validation(*args, **kwargs):
            ...
            if cn != "superadmin":
                prob = ProblemDetails(title="Unauthorized", detail="User not authorized", cause="You are not superadmin user")
...
def get_invokers():
    ...
    Retrieve all invokers registered in CAPIF.

    :param api_backoffice_enrolment_details:
    :type api_backoffice_enrolment_details: dict | bytes
