...
| apiInvocationLogs.apiInvocationLogs.image.tag | string | `""` |  |
...
| apiInvokerManagement.apiInvokerManagement.image.tag | string | `""` |  |
...
| apiProviderManagement.apiProviderManagement.image.tag | string | `""` |  |
...
| capifEvents.capifEvents.image.tag | string | `""` |  |
...
| capifRoutingInfo.capifRoutingInfo.image.tag | string | `""` |  |
...
| capifSecurity.capifSecurity.image.tag | string | `""` |  |
...
| easyRsa.easyRsa.image.tag | string | `""` |  |
...
| jwtauth.jwtauth.image.tag | string | `""` |  |
...
| mongoExpress.mongoExpress.image.tag | string | `""` |  |
...
| publishedApis.publishedApis.image.tag | string | `""` |  |
...
| serviceApis.serviceApis.image.tag | string | `""` |  |
