...
* **Information of Test**:
  ...
  9.  Request Discover Published APIs:
...
* **Information of Test**:
  ...
  8.  Onboard Invoker:
     ...
     * Reference Request Body: [invoker onboarding body]
     * "onboardingInformation"->"apiInvokerPublicKey": must contain public key generated by Invoker.
  9.  Request Discover Published APIs by no invoker entity:
     * Send GET to *https://{CAPIF_HOSTNAME}/service-apis/v1/allServiceAPIs?api-invoker-id={apiInvokerId}*
     * Param api-invoker-id is mandatory
...
* **Information of Test**:
  ...
  8.  Onboard Invoker:
     ...
     * Reference Request Body: [invoker onboarding body]
     * "onboardingInformation"->"apiInvokerPublicKey": must contain public key generated by Invoker.
  9.  Request Discover Published APIs with not valid apiInvoker:
...
* **Information of Test**:
  ...
  8.  Onboard Invoker:
     ...
     * Reference Request Body: [invoker onboarding body]
     * "onboardingInformation"->"apiInvokerPublicKey": must contain public key generated by Invoker.
  10. Request Discover Published APIs filtering by api-name:
...
* **Information of Test**:
  ...
  8.  Onboard Invoker:
     ...
     * Reference Request Body: [invoker onboarding body]
     * "onboardingInformation"->"apiInvokerPublicKey": must contain public key generated by Invoker.
  9.  Request Discover Published APIs filtering by api-name not published:
...
* **Information of Test**:
  ...
  8.  Onboard Invoker:
     ...
     * Reference Request Body: [invoker onboarding body]
     * "onboardingInformation"->"apiInvokerPublicKey": must contain public key generated by Invoker.
  9.  Request Discover Published APIs not filtered:
