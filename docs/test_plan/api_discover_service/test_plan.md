...
* Information of Test:
  ...
  7. Request Discover Published APIs with not valid apiInvoker:
     * Send GET to ccf_discover_url *https://{CAPIF_HOSTNAME}/service-apis/v1/allServiceAPIs?api-invoker-id={INVOKER_NOT_REGISTERED}*
     * Param api-invoker-id is mandatory
...
* Information of Test:
  ...
  5. Create public and private key at invoker

  6. Register of Invoker at CCF:
     * Send POST to http://{CAPIF_HOSTNAME}:{CAPIF_HTTP_PORT}/register 
     * body [invoker register body]
     * get ccf_dicover_url
  ...
  8. Request Discover Published APIs filtering by api-name:
...
* Execution Steps:
  ...
  2. Register Invoker and Onboard Invoker at CCF
  3. Discover Service APIs by Invoker.
  4. Discover filered by api-name service_1 Service APIs by Invoker
...
* Information of Test:
  ...
  8. Request Discover Published APIs filtering by api-name not published:
