...
invokerid=$(curl --request POST "http://$capifhost:8080/register" --header 'Content-Type: application/json' --data '{
    "username":"invoker",
    "password":"invoker",
    "role":"invoker",
    "description":"Invoker",
...
invokertoken=$(curl --request POST "http://$capifhost:8080/gettoken" --header 'Content-Type: application/json' --data '{
    "username":"invoker",
    "password":"invoker",
    "role":"invoker"
